...
.btn-primary, .btn-primary:active, .btn-primary:focus {
  ...
  .btn-primary:hover, .btn-primary:active:hover, .btn-primary:focus:hover {
    background: #1a755f !important;
    border: 1px solid #1a755f !important;
    outline: none !important;
...
input.form-control {
  ...
  input.form-control:focus {
    border-color: #3cd3ae;
    outline: 0;
    box-shadow: inset 0 1px 1px rgba(0, 0, 0, 0.075), 0px 0px 5px rgba(31, 138, 112, 0.6); }
...
.lecture-attachment p, .post p {
  ...
  .lecture-attachment p.lecture-description, .post p.lecture-description {
    margin-bottom: 17px; }
.lecture-attachment ul li, .lecture-attachment ol li, .post ul li, .post ol li {
  font-size: 17px;
  font-weight: normal;
  line-height: 26px;
  margin-bottom: 15px; }
.lecture-attachment blockquote, .post blockquote {
  margin: 30px 0px;
  line-height: 33px; }
.lecture-attachment img, .post img {
  max-width: 100%; }
...
.devise-layout {
  ...
  .devise-layout .content {
    ...
    .devise-layout .content label {
      ...
      color: #2b3636;
      width: 100%; }
      .devise-layout .content label select {
        width: 100% !important; }
...
.enrollment-step-indicator {
  ...
  .enrollment-step-indicator .step-1, .enrollment-step-indicator .step-2, .enrollment-step-indicator .step-3 {
    ...
    .enrollment-step-indicator .step-1.step-2, .enrollment-step-indicator .step-1.step-3, .enrollment-step-indicator .step-2.step-2, .enrollment-step-indicator .step-2.step-3, .enrollment-step-indicator .step-3.step-2, .enrollment-step-indicator .step-3.step-3 {
      border-left: 1px solid rgba(31, 138, 112, 0.2); }
...
.course-listing {
  ...
  .course-listing:hover {
    box-shadow: 0px 0px 0px 1px #6bbda9;
  ...
  .course-section ul.section-list {
    ...
    .course-section ul.section-list .section-item {
      ...
      .course-section ul.section-list .section-item .title-container {
        border-left: 1px solid rgba(31, 138, 112, 0.1);
        margin: -11px;
        padding: 10px;
        margin-left: 41px;
        padding-right: 70px; }
      ...
      .course-section ul.section-list .section-item.completed .status-icon {
        background: url("//d2oz8i5n9se8ej.cloudfront.net/icons/course-complete.png") 1px 0px #b8b8b8;
        background-size: 96%; }
      ...
      .course-section ul.section-list .section-item.incomplete .status-icon {
        background: none;
        box-shadow: inset 0px 0px 0px 2px #1F8A70; }
      .course-section ul.section-list .section-item.incomplete .item:hover .status-icon {
        box-shadow: inset 0px 0px 0px 2px #16604e; }
      ...
      .course-section ul.section-list .section-item.next-lecture .status-icon {
        background: url("//d2oz8i5n9se8ej.cloudfront.net/icons/course-incomplete.png") 1px 0px #2b3636;
...
.course-sidebar .row.lecture-sidebar {
  ...
  .course-sidebar .row.lecture-sidebar .course-section {
    ...
    .course-sidebar .row.lecture-sidebar .course-section .section-title {
      border-bottom: 1px solid rgba(31, 138, 112, 0.1); }
    .course-sidebar .row.lecture-sidebar .course-section .section-item {
      border-bottom: 1px solid rgba(31, 138, 112, 0.1) !important; }
...
.homepage-hero {
  ...
  .homepage-hero::after {
    content: "";
    background: url("https://d2vvqscadf4c1f.cloudfront.net/8r1AfTaRJWoDfQxILpq6_Design%20+%20Phone.jpg") !important;
    background-size: cover !important;
...
.view-school .course-block {
  padding-bottom: 50px;
  padding-top: 50px; }
  .view-school .course-block.hero, .view-school .course-block.coupon_banner, .view-school .course-block.html, .view-school .course-block.liquid, .view-school .course-block.full_width_image, .view-school .course-block.embedded_form {
    padding-top: 0px;
    padding-bottom: 0px; }
  .view-school .course-block.coupon_banner {
    display: none; }
  .view-school .course-block.odd-stripe {
    background-color: #f7f7f7; }
  .view-school .course-block.even-stripe {
    background-color: #FFF; }
  .view-school .course-block.bio .author-name {
    margin-top: 10px;
    font-size: 18px;
    font-weight: bold; }
  .view-school .course-block.checkout h2 {
    text-align: center;
    font-weight: bold; }
    .view-school .course-block.checkout h2.no-products {
      margin-bottom: 70px; }
  .view-school .course-block .full-width-image-bg {
    background-size: cover !important;
    background-position: center !important;
    padding-top: 100px;
    padding-bottom: 100px;
    color: #fff;
    position: relative; }
    .view-school .course-block .full-width-image-bg.embedded-form {
      padding-top: 20px;
      padding-bottom: 40px; }
      .view-school .course-block .full-width-image-bg.embedded-form .preenrollment-form-wrapper {
        background: none; }
        .view-school .course-block .full-width-image-bg.embedded-form .preenrollment-form-wrapper .btn-primary.btn-hg {
          font-size: 18px !important;
          text-transform: uppercase; }
    .view-school .course-block .full-width-image-bg.background-not-set h3.signup-form-title {
      color: #2b3636 !important; }
  .view-school .course-block.testimonial .large-img-rounded {
    width: 100px;
    height: 100px; }
  .view-school .course-block.testimonial p.testimonial-quote {
    font-size: 20px;
    margin-top: 7px;
    line-height: 30px; }
...
.unlaunched-page {
  ...
  background-image: url("https://d2vvqscadf4c1f.cloudfront.net/8r1AfTaRJWoDfQxILpq6_Design%20+%20Phone.jpg"); }
